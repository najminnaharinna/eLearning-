...
<div class="container" >
    <h1 class="about-page" style="margin-top: 160px; margin-bottom:25px; color:#02aeca; font-size:40px; text-align:center;text-decoration: underline;
            ...
            <div>
                <div id="disqus_thread"></div>
                    ...
                    */
                    ...
                    s.src = 'https://elearning-9.disqus.com/embed.js';
