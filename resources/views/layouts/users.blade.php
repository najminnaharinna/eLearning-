...
<!-- Sidebar -->
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Nav Item - Dashboard -->
        <li class="nav-item">
            <a class="nav-link" href="{{ url('users/password') }}">
            <i class="fas fa-fw fa-tachometer-alt"></i>
        ...
        <!-- Nav Item - Pages Collapse Menu -->
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#sectinos" aria-expanded="true" aria-controls="sectinos">
            <i class="fas fa-fw fa-cog"></i>
            <span> Sections </span>
            </a>
        ...
        <!-- Nav Item - Pages Collapse Menu -->
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#lessons" aria-expanded="true" aria-controls="lessons">
            <i class="fas fa-fw fa-cog"></i>
            <span> Lessons </span>
            </a>
