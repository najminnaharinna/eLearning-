...
<h2 class="text-center">Create New Lesson</h2>
    <div class="container col-md-10 offset-md-1">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
               {!! Form::open(array('url'=>'users/lessons', 'methode'=>'PUL','files'=> true)) !!}    
                    @csrf 
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::textarea('discription', NULL,['class'=>'form-control', 'id'=>'editor' ,'placeholder'=>'Enter lesson Discription ']) !!}
